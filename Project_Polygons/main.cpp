...
std::cout << "Polygon Type: " << this->m_strType << ", Width: " << this->m_dWidth << ", Height: "
        << this->m_dHeight << std::endl;
return;
...
double Triangle::area(){
    ...
    return (0.5 * (this->m_dHeight * this->m_dWidth));
...
p_polygon[i]->displayProperties(); // take advantage of reuse; use base
//class function
